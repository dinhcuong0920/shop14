						...
						<div class="row row-pb-lg">
							...
							<div class="col-md-4 text-center">
									<div class="product-entry">
										<div class="product-img" style="background-image: url(/admins/img/{{$product->img}});">
											<p class="tag"><span @if($product->featured==1) class="new" @endif >@if($product->featured==1) New @endif</span></p>
											<div class="cart">
												<p>
													<span class="addtocart"><a href="/products/detail/{{$product->slug}}"><i class="icon-shopping-cart"></i></a></span>
												<span><a href="/products/detail/{{$product->slug}}"><i class="icon-eye"></i></a></span>
												</p>
											</div>
										</div>
										<div class="desc">
											<h3><a href="/products/detail/{{$product->slug}}">{{$product->name}}</a></h3>
												...
												<div class="panel-body">
													<ul>
														@foreach ($category as $cate1)
															...
															<li><a href="/products?category={{$cate1->id}}">{{$cate1->name}}</a></li>
															@endif
														@endforeach
													</ul>
												</div>
