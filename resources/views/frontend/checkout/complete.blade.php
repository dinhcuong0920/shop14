				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<p>
							...
							<a href="/products" class="btn btn-primary btn-outline">Tiếp tục mua sắm</a>
						</p>
					</div>
				</div>
				<div class="row mt-50">
						...
						<div class="col-12">
							<div class="order-wrapper mt-50">
								...
								<div class="order-list">
									...
									<div class="list-row d-flex justify-content-between">
											<div class="col-md-4">{{$order->name}} : @foreach($order->attr as $attr) {{$attr->name}}:{{$attr->value}}@endforeach</div>
									<div class="col-md-4" align='right'>x {{$order->quantity}}</div>
											<div class="col-md-4" align='right'>₫ {{number_format($order->price,0,'','.')}}</div>
									</div>
									@endforeach
