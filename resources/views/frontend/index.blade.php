					...
					<div class="col-md-3 text-center">
							<div class="product-entry">
								<div class="product-img" style="background-image: url(/admins/img/{{$product->img}});">
									...
									<div class="cart">
										<p>
										<span class="addtocart"><a href="/products/detail/{{$product->id}}"><i class="icon-shopping-cart"></i></a></span>
											<span><a href="/products/detail/{{$product->id}}"><i class="icon-eye"></i></a></span>
										</p>
									</div>
								</div>
								<div class="desc">
									<h3><a href="shop.html">{{$product->name}}</a></h3>
								<p class="price"><span>đ {{number_format($product->price,0,'','.')}}</span> </p>
								</div>
							</div>
						</div>
					@endforeach
					...
					<div class="col-md-3 text-center">
							<div class="product-entry">
								<div class="product-img" style="background-image: url(/admins/img/{{$product->img}});">
									...
									<div class="cart">
										<p>
											<span class="addtocart"><a href="/products/detail"><i class="icon-shopping-cart"></i></a></span>
											<span><a href="/products/detail"><i class="icon-eye"></i></a></span>
