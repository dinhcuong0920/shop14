                            ...
                            <table class="table table-bordered" style="margin-top:20px;">
                                ...
                                <tbody>
                                    ...
                                    <td>{{$product->id}}</td>
                                            <td>
                                                <div class="row">
                                                <div class="col-md-3"><img src='/admins/img/{{$product->img}}' alt="Áo đẹp"
                                            ...
                                            <a href="/admin/product/edit/{{$product->id}}" class="btn btn-warning"><i class="fa fa-pencil"
                                                ...
                                                <a onclick='return Del("{{$product->name}}")' href="/admin/product/del/{{$product->id}}" class="btn btn-danger"><i class="fa fa-trash"
