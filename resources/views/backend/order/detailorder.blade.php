...
@section('content')
					...
					<div class="panel-body">
						<div class="bootstrap-table">
							<div class="table-responsive">
										...
										@foreach ($customer->order as $order)
											<tr>
												...
												<td>
													<div class="row">
														<div class="col-md-4">
															<img width="100px" src="/admins/img/{{$order->img}}" class="thumbnail">
														</div>
														<div class="col-md-8">
															<p>Mã sản phẩm:</p>
												...
												<td>{{number_format($total=$order->price * $order->quantity,0,'','.')}} VNĐ</td>
								...
								<a onclick="return OrderProcess()" name="" id="" class="btn btn-success" href="/admin/order/orderprocessed/{{$customer->id}}" role="button">Đã xử lý</a>
								</div>
							</div>
						</div>
	...
	{
		return confirm('Đơn hàng đã xử lý sẽ được tính vào phần doanh thu!')
	}
	</script>
